...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QString::fromUtf8("0 BBL"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 BBL"));
        ...
        labelImmature->setText(QString::fromUtf8("0 BBL"));
        ...
        label_wallet_bgcoin = new QLabel(frame);
        ...
        verticalLayout_4->addWidget(label_wallet_bgcoin);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "<html><head/><body><p>The displayed information may be out of date. Your wallet automatically synchronizes with the Babylonian network after a connection is established, but this process has not completed yet.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
