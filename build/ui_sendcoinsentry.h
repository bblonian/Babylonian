...
public:
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "<html><head/><body><p>The address to send the payment to (e.g. si1NooNjQySQLDJ643HWfZZ7UN2EmLEvix)</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
