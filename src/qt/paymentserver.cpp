...
const QString BITCOIN_IPC_PREFIX("Babylonian:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Babylonian: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Babylonian: click-to-pay handler");
    else
...
{
    // clicking on Babylonian: URLs creates FileOpen events on the Mac:
